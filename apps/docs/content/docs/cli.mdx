...
[`@sigil-ui/cli` on npm](https://www.npmjs.com/package/@sigil-ui/cli)
...
Use [`create-sigil-app`](https://www.npmjs.com/package/create-sigil-app) for a fresh Next.js project:
