...
export function LandingFooter({ fullBleed = false }: { fullBleed?: boolean }) {
        ...
        <footer className="w-full bg-[var(--s-surface)]">
          <div
            ...
            style={{
              ...
              padding: "var(--s-footer-padding-y, 48px) var(--s-section-padding-x, var(--s-page-margin, 24px))",
            }}
          >
            {footerContent}
          </div>
  ...
  return (
    <>
      <SectionDivider size="md" showCross fadeEdges />
      <SigilSection as="footer" showCrosses padding="var(--s-footer-padding-y, 48px) var(--s-section-padding-x, var(--s-page-margin, 24px)) var(--s-footer-padding-y, 48px)">
        {footerContent}
      </SigilSection>
    </>
  );
