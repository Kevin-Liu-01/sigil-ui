...
import { PresetGrid } from "@/components/landing/preset-grid";
...
export default function PresetsPage() {
  return (
    <SigilFrame>
      ...
      <SigilSection borderTop padding="96px 24px 48px">
        <div className="mb-12">
          ...
          <p className="font-[family-name:var(--s-font-mono)] text-sm leading-relaxed text-[var(--s-text-secondary)] mb-6 max-w-[528px]">
            One command switches all 259 tokens at once. Six aesthetic families —
            structural, minimal, dark, colorful, editorial, industrial. Click any preset
            to apply it live.
          </p>
      ...
      <SigilSection>
        <TechFrame variant="ticks" extend={8} opacity={0.2}>
          <PresetGrid />
        </TechFrame>
      </SigilSection>
