---
title: NetworkGraph
description: "A node-link network graph for relationship visualization."
---
...
|---|---|---|---|
| `nodes` | `NetworkNode[]` | — | Node positions, labels, and sizes |
| `edges` | `NetworkEdge[]` | — | Edges with optional weight |
