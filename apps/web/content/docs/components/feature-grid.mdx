...
<ComponentPreview>
  <FeatureGrid items={[{ title: "Fast", description: "Optimized for performance" }, { title: "Accessible", description: "WCAG 2.1 compliant" }, { title: "Themeable", description: "44 presets included" }]} />
</ComponentPreview>
