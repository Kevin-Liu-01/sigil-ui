...
The sandbox has its own component registry mapping string names to `@sigil-ui/components` with default props. This is separate from the CLI registry and includes the full 65-component library.
