...
export const prismPreset: SigilPreset = completePreset({
  ...
  tokens: {
    colors: {
      ...
      border: { light: "oklch(0.65 0.01 300)", dark: "oklch(0.260 0.012 280)" },
      "border-muted": { light: "oklch(0.82 0.006 300)", dark: "oklch(0.200 0.010 280)" },
      "border-strong": { light: "oklch(0.55 0.018 300)", dark: "oklch(0.340 0.018 280)" },
      ...
      highlight: { light: "oklch(0.92 0.08 300)", dark: "oklch(0.28 0.06 300)" },
    },
    typography: {
