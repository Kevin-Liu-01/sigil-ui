...
export const cipherPreset: SigilPreset = completePreset({
  ...
  tokens: {
    colors: {
      ...
      "text-muted": { light: "oklch(0.5 0.01 155)", dark: "oklch(0.6 0.04 145)" },
      "text-subtle": { light: "oklch(0.62 0.008 155)", dark: "oklch(0.48 0.025 145)" },
      ...
      border: { light: "oklch(0.64 0.015 155)", dark: "oklch(0.240 0.025 155)" },
      "border-muted": { light: "oklch(0.81 0.010 155)", dark: "oklch(0.180 0.018 155)" },
      "border-strong": { light: "oklch(0.64 0.025 155)", dark: "oklch(0.320 0.030 155)" },
      ...
      highlight: { light: "oklch(0.92 0.08 145)", dark: "oklch(0.28 0.06 145)" },
    },
    typography: {
    ...
    sections: {
      "padding-y": "3.5rem",
      "padding-y-sm": "1.75rem",
      gap: "24px",
      "padding-y-lg": "5.25rem",
      "padding-y-xl": "7rem",
