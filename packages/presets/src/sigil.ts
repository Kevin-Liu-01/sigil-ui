...
export const sigilPreset: SigilPreset = {
  ...
  tokens: {
    ...
    sigil: {
      ...
      "rail-gap": "24px",
      "card-radius": "10px",
      "gutter-pattern": "horizontal-fine",
      "margin-pattern": "horizontal-thin",
    ...
    sections: {
      ...
      "description-gap": "calc(var(--s-grid-cell) / 5)",
    ...
    hero: {
      "min-height": "auto",
      // Integer multiples of --s-grid-cell only — keeps section/divider edges on rail lines.
      "padding-y": "calc(2 * var(--s-grid-cell))",
      "padding-y-sm": "calc(1 * var(--s-grid-cell))",
      "padding-x": "var(--s-page-margin, 20px)",
      "content-max": "31rem",
      "content-basis": "min(38%, var(--s-hero-content-max, 31rem))",
      "content-align": "center",
      layout: "split",
