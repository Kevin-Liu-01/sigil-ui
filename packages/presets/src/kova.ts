...
export const kovaPreset: SigilPreset = completePreset({
  ...
  tokens: {
    colors: {
      ...
      border: { light: "oklch(0.65 0.004 235)", dark: "oklch(0.270 0.006 240)" },
      "border-muted": { light: "oklch(0.82 0.006 235)", dark: "oklch(0.210 0.006 240)" },
      "border-strong": { light: "oklch(0.55 0.008 235)", dark: "oklch(0.350 0.010 240)" },
      ...
      "info-muted": "oklch(0.70 0.06 255)",
