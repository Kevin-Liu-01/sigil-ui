...
export const sandPreset: SigilPreset = {
  ...
  tokens: {
    colors: {
      ...
      border: { light: "oklch(0.85 0.035 80)", dark: "oklch(0.330 0.030 65)" },
      "border-muted": { light: "oklch(0.91 0.025 80)", dark: "oklch(0.270 0.025 65)" },
      "border-strong": { light: "oklch(0.75 0.04 75)", dark: "oklch(0.410 0.040 65)" },
