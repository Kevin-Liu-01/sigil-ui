...
export const duskPreset: SigilPreset = {
  ...
  tokens: {
    colors: {
      ...
      border: { light: "#8d87ab", dark: "oklch(0.380 0.035 296)" },
      "border-muted": { light: "#c2bdd9", dark: "oklch(0.320 0.025 296)" },
      "border-strong": { light: "#9181c6", dark: "oklch(0.472 0.045 293)" },
      ...
      "gradient-end": "#f472b6",
      glow: "#a78bfa50",
      highlight: { light: "#ede9fe", dark: "rgba(139, 108, 247, 0.15)" },
    },
    typography: {
