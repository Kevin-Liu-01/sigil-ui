...
export const clayPreset: SigilPreset = {
  ...
  metadata: {
    ...
    mood: "warm, earthy, handcrafted",
    tags: ["edgeless", "warm", "earthy", "serif", "colorful-bg"],
  },
  tokens: {
    colors: {
      background: { light: "oklch(0.93 0.035 55)", dark: "oklch(0.16 0.04 40)" },
      surface: { light: "oklch(0.90 0.04 55)", dark: "oklch(0.20 0.045 40)" },
      "surface-elevated": { light: "oklch(0.95 0.03 55)", dark: "oklch(0.24 0.04 40)" },
      "surface-sunken": { light: "oklch(0.87 0.045 55)", dark: "oklch(0.12 0.035 40)" },
      primary: { light: "oklch(0.55 0.16 40)", dark: "oklch(0.68 0.14 40)" },
      "primary-hover": { light: "oklch(0.48 0.18 40)", dark: "oklch(0.74 0.12 40)" },
      "primary-muted": { light: "oklch(0.55 0.05 40)", dark: "oklch(0.68 0.04 40)" },
      "primary-contrast": { light: "oklch(0.98 0.01 55)", dark: "oklch(0.16 0.04 40)" },
      secondary: "oklch(0.58 0.09 75)",
      "secondary-hover": "oklch(0.52 0.11 75)",
      "secondary-muted": "oklch(0.58 0.03 75)",
      accent: "oklch(0.62 0.10 25)",
      "accent-hover": "oklch(0.56 0.12 25)",
      "accent-muted": "oklch(0.62 0.04 25)",
      text: { light: "oklch(0.22 0.03 40)", dark: "oklch(0.90 0.025 55)" },
      "text-secondary": { light: "oklch(0.38 0.025 40)", dark: "oklch(0.74 0.02 55)" },
      "text-muted": { light: "oklch(0.52 0.02 40)", dark: "oklch(0.56 0.02 55)" },
      "text-subtle": { light: "oklch(0.64 0.02 45)", dark: "oklch(0.44 0.02 50)" },
      "text-disabled": { light: "oklch(0.76 0.015 45)", dark: "oklch(0.32 0.015 45)" },
      "text-inverse": { light: "oklch(0.90 0.025 55)", dark: "oklch(0.22 0.03 40)" },
      border: { light: "oklch(0.82 0.03 55)", dark: "oklch(0.340 0.030 40)" },
      "border-muted": { light: "oklch(0.88 0.02 55)", dark: "oklch(0.280 0.025 40)" },
      "border-strong": { light: "oklch(0.72 0.04 50)", dark: "oklch(0.420 0.040 40)" },
      "border-interactive": { light: "oklch(0.55 0.16 40)", dark: "oklch(0.68 0.14 40)" },
      ...
      "gradient-start": { light: "oklch(0.55 0.16 40)", dark: "oklch(0.68 0.14 40)" },
      "gradient-end": { light: "oklch(0.58 0.09 75)", dark: "oklch(0.62 0.10 75)" },
      glow: { light: "oklch(0.55 0.16 40 / 0.15)", dark: "oklch(0.68 0.14 40 / 0.12)" },
      highlight: { light: "oklch(0.93 0.06 40)", dark: "oklch(0.28 0.05 40)" },
    },
    typography: {
      ...
      "heading-family": "'DM Serif Display', Georgia, serif",
    },
    spacing: {
    ...
    shadows: {
      sm: "0 1px 3px 0 oklch(0.35 0.04 40 / 0.06)",
      md: "0 2px 8px -1px oklch(0.35 0.04 40 / 0.08), 0 1px 3px 0 oklch(0.35 0.04 40 / 0.05)",
      lg: "0 4px 14px -2px oklch(0.35 0.04 40 / 0.10), 0 2px 4px 0 oklch(0.35 0.04 40 / 0.04)",
      xl: "0 8px 28px -4px oklch(0.35 0.04 40 / 0.12), 0 4px 8px -2px oklch(0.35 0.04 40 / 0.05)",
      "2xl": "0 16px 48px -8px oklch(0.35 0.04 40 / 0.14)",
      glow: "0 0 24px oklch(0.55 0.16 40 / 0.15)",
      "glow-sm": "0 0 12px oklch(0.55 0.16 40 / 0.1)",
      colored: "0 4px 16px -4px oklch(0.55 0.16 40 / 0.2)",
      inner: "inset 0 2px 4px 0 oklch(0.35 0.04 40 / 0.05)",
      card: "0 1px 4px 0 oklch(0.35 0.04 40 / 0.05)",
      button: "0 1px 2px 0 oklch(0.35 0.04 40 / 0.05)",
      "button-hover": "0 2px 6px -1px oklch(0.35 0.04 40 / 0.09)",
      dropdown: "0 4px 14px -2px oklch(0.35 0.04 40 / 0.12)",
      modal: "0 20px 40px -8px oklch(0.35 0.04 40 / 0.18)",
    },
    motion: {
      duration: { instant: "0ms", fast: "130ms", normal: "240ms", slow: "400ms", slower: "580ms", slowest: "850ms" },
      easing: {
    ...
    code: {
      ...
      "keyword-color": "oklch(0.55 0.16 40)",
