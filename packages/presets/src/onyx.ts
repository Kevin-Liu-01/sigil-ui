...
export const onyxPreset: SigilPreset = completePreset({
  ...
  tokens: {
    colors: {
      ...
      border: { light: "oklch(0.65 0.006 310)", dark: "oklch(0.240 0.010 300)" },
      "border-muted": { light: "oklch(0.82 0.006 310)", dark: "oklch(0.180 0.008 300)" },
      "border-strong": { light: "oklch(0.65 0.01 310)", dark: "oklch(0.320 0.014 300)" },
