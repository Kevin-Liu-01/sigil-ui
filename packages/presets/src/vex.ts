...
export const vexPreset: SigilPreset = {
  ...
  tokens: {
    colors: {
      ...
      border: { light: "#000000", dark: "oklch(0.380 0.035 102)" },
      "border-muted": { light: "#333333", dark: "oklch(0.320 0.025 107)" },
      "border-strong": { light: "#000000", dark: "oklch(0.471 0.045 103)" },
      ...
      "gradient-end": "#000000",
      glow: "#ec489960",
      highlight: { light: "#fce7f3", dark: "rgba(236, 72, 153, 0.15)" },
    },
    typography: {
