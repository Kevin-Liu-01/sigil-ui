...
export const helixPreset: SigilPreset = {
  ...
  tokens: {
    colors: {
      ...
      border: { light: "oklch(0.66 0.008 170)", dark: "oklch(0.260 0.010 170)" },
      "border-muted": { light: "oklch(0.83 0.006 170)", dark: "oklch(0.200 0.008 170)" },
      "border-strong": { light: "oklch(0.66 0.012 170)", dark: "oklch(0.340 0.014 170)" },
