...
const variantStyles: Record<string, string> = {
  default: "bg-transparent hover:bg-[var(--s-surface-elevated)] data-[state=on]:bg-[var(--s-surface)] data-[state=on]:border-[color:var(--s-border-strong)]",
  outline: "border border-[style:var(--s-border-style,solid)] border-[color:var(--s-border)] hover:bg-[var(--s-surface-elevated)] data-[state=on]:bg-[var(--s-surface)] data-[state=on]:border-[color:var(--s-border-strong)]",
};
