  ...
  return (
    <div
      ...
      className={cn(
        ...
        "flex w-full flex-col gap-4 rounded-[var(--s-radius-card,0px)] border border-[style:var(--s-border-style,solid)] border-[color:var(--s-border)] bg-[var(--s-surface)] p-0 text-[var(--s-text)] shadow-[var(--s-shadow-sm)]",
