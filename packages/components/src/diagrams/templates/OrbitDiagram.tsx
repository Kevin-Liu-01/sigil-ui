  ...
  function OrbitDiagram({ center, nodes, size = 260, labels = [], className, ...props }, ref) {
    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center gap-1 px-4 py-3 rounded-[var(--s-radius-lg,0px)] border-2 border-[color:var(--s-primary)] bg-[var(--s-background)] text-center">
        ...
        {nodes.map((node, i) => {
          ...
          return (
            ...
            >
              <div className="flex items-center justify-center w-9 h-9 rounded-[var(--s-radius-full,9999px)] border border-[color:var(--s-border)] bg-[var(--s-surface)] [&_svg]:size-4 text-[var(--s-text-muted)]">
