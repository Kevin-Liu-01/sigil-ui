  ...
  function EcosystemDiagram({ center, ring, size = 280, className, ...props }, ref) {
    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center gap-1 px-4 py-3 rounded-[var(--s-radius-full,9999px)] border-2 border-[color:var(--s-primary)] bg-[var(--s-background)] text-center">
        ...
        {ring.map((node, i) => {
          ...
          return (
            ...
            >
              <div className="flex items-center justify-center w-8 h-8 rounded-[var(--s-radius-full,9999px)] border border-[color:var(--s-border)] bg-[var(--s-surface)] [&_svg]:size-3.5 text-[var(--s-text-muted)]">
