 ...
 * @sigil-ui/primitives
 *
 * Headless behavior primitives re-exported from Radix UI.
 * These provide accessible, unstyled interaction patterns
 * that @sigil-ui/components layers design tokens onto.
 */
